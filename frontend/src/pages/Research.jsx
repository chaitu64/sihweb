...
function Research() {
  const pdfUrl = "/GeoSR-AI_2Page_Research_Paper.pdf";
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 36, flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{
          ...
          <button
            ...
            title={enableText ? "Text selection is enabled" : "Enable text selection (may affect layout rendering)"}
            style={{
      ...
      <div style={{ textAlign: "center", marginTop: 24, marginBottom: 32 }}>
        <a
          href={pdfUrl}
          download="GeoSR-AI_2Page_Research_Paper.pdf"
          style={{
            display: "inline-flex",
            alignItems: "center",
            gap: 8,
